    ...
    <section id="contact" className="section-padding bg-secondary/30 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto max-w-5xl">
        <motion.div
          ...
          className="rounded-2xl bg-[#163a5a] text-white p-6 md:p-8 lg:p-10"
        >
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold tracking-wider uppercase mb-2">Contact</h2>
              <div className="w-full h-px bg-white/70 mb-5" />

              <div className="space-y-4 text-base md:text-lg">
                <a href="tel:+85531232668" className="flex items-start gap-3 text-white/95 hover:text-white transition-colors">
                  <Phone size={18} className="mt-1" />
                  <span>(+855) 31-232-6668</span>
                </a>

                <a href="mailto:phournkoemseang@gmail.com" className="flex items-start gap-3 text-white/95 hover:text-white transition-colors break-all">
                ...
                <a
                  ...
                  className="inline-block underline text-white/95 hover:text-white"
                >
            ...
            <div>
              ...
              <div className="space-y-7 text-white/95">
                <div>
                  ...
                  <p className="text-2xl font-bold uppercase leading-tight mt-1">Pursuing Associate Degree</p>
                  <p className="mt-2 text-lg">At Passerelles Numeriques Cambodia (PNC)</p>
                </div>

                <div>
                  <p className="text-xl font-semibold">2021 - 2024</p>
                  <p className="text-2xl font-bold uppercase leading-tight mt-1">Graduate Form High School</p>
